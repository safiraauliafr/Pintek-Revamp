...
class ForgotPassword {
	...
	//Obsolete step
	@When('I use email as (.*)')
	def I_enter_username_password(String email) {
		WebUI.callTestCase(findTestCase("Test Cases/Pintek ProcessCase/Request Forgot Password"), [ ('email') : email ], FailureHandling.STOP_ON_FAILURE)
	}
