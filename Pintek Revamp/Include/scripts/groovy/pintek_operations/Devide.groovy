...
class LoginSteps {
	...
	//Obsolete step
	@When('I login using username as (.*) and password as (.*)')
	def I_enter_username_password(String username, String password) {
		WebUI.callTestCase(findTestCase("Test Cases/Pintek CommonCase/Login Web"), [ ('username') : username, ('password') : password ], FailureHandling.STOP_ON_FAILURE)
	}
